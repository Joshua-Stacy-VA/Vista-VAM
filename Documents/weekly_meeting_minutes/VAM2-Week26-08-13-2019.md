...
| 2. | Introductions |  | 
| 3. | Key Points </br>  1. high level summaries will be presented for:  </br>  a. Management  </br>  b. Technical  </br> </br> 2. Agenda for each track:  </br>  i. Overview of progress  </br> ii. What was accomplished in the prior week </br> iii. What is planned for the coming week </br>  iv.	Are we on track to meet deadlines (display GANTT chart) | 1. **Nilesh** did the roll call.  2. **Nilesh** provided high level update on the eMASS dashboard.  3. **David** provided detailed updated for the eMAS Process.<ul><li> David di a dance.</li> <li>David danced </li></ul>   4) **Dr. Richards** commented... </br> </br> 5) **Conor** provided... | 
