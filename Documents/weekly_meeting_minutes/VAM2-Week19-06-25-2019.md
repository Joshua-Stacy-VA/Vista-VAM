...
| 2. | Introductions |  | 
| 3. | Key Points </br> 1.	high level summaries will be presented for: </br> a.	Management </br> b.	Technical </br> 2.	Agenda for each track: </br> i.	Overview of progress </br> ii.	What was accomplished in the prior week </br> iii.	What is planned for the coming week iv.	Are we on track to meet deadlines (display GANTT chart) | 1) **Nilesh** did the roll call. </br> </br> 2) **Piyush** provided an update on PIA review from Bobbi and re-approval from PIA Support Group and PO.  The document is with SO now for his signature. </br> </br> 3)  **David** mentioned five other documents are ready for final signatures.  </br> </br> 4) **David** provided a detailed update on teh stats of the scans.  </br> </br>  5) **Conor** provided an update on Mirror and Monitor. </br> </br> 6) **Conor** also mentioned that the RPC Test Suite is being finalized. </br> </br> 7) **Nilesh** requested the team to complete the TRM Training without any further delays. </br> </br>  8) **Nilesh** provided an update on Christie and Adam's PIV access and onboarding  | 
